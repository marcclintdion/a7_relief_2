...
GLfloat     cube_relief_LIGHT_POSITION_02[] = {-2.0, 7.34002,  15.9701, 1};

GLfloat     cube_relief_LIGHT_POSITION_03[] = {2.0, 4.34002,  10.9701, 1};


//----                                                                                                
GLuint      UNIFORM_LIGHT_POSITION_01_cube_relief; 
GLuint      UNIFORM_LIGHT_POSITION_02_cube_relief;        
GLuint      UNIFORM_LIGHT_POSITION_03_cube_relief; 
GLuint      UNIFORM_LIGHT_POSITION_04_cube_relief; 


var         cube_relief_ATTENUATION            =  1.0;
var         cube_relief_SHININESS              =  -0.005;
//------------------------------------------------------------------------ 
